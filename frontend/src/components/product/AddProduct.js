  ...
  return (
       ...
       <div className='container'>
        <div className='text-base font-medium mb-5'>
            <span><i class='bx bx-left-arrow-alt text-lg'></i> Add Product</span>
        </div>
         ...
         <div class="relative col-md-4 col-sm-12">
          ...
          <div class="relative col-md-4 col-sm-12">
            <div className='form-group'>
             ...
             <select class="form-select form-select-sm shadow-none border rounded-lg px-3 py-2 mb-5 text-xs" aria-label=".form-select-sm example">
               <option selected className='text-gray-400 '>select sub category name</option>
       ...
       <div class="relative col col-md-2">
            <div className='form-group'>
             ...
             <img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQSR5CJVz2Po0GeU6zM7QiCQNzmgrfpYtImFw&s' className='border rounded-lg px-5 py-4' alt='img' />
          </div>
          </div>
          <div class="relative col col-md-2">
